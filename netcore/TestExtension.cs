...
namespace congestion.calculator
{
    ...
    {
        public static void RunTests(this IServiceProvider serviceProvider)
        {
            ...
            Console.WriteLine($"Result: {result3} SEK (Expected: 60 SEK)");
            Console.WriteLine($"Status: {(result3 == 60 ? "✓ PASS" : "✗ FAIL")}\n");
